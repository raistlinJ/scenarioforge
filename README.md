...
- [Proxmox three-VM installer](scripts/proxmox/README.md)
...
- [scripts/proxmox/README.md](scripts/proxmox/README.md) – provision the complete CORE, ScenarioForge, and participant VM layout from a Proxmox shell.
